    ...
    <section id="about" className="py-20">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="md:w-1/2">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Hanzala Khan</h1>
          <h2 className="text-xl md:text-2xl text-text-light mb-6">Fresher — Software / Android App Developer</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="#projects" className="border border-border-color px-6 py-2 rounded text-center hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              View Projects
            </a>
          </div>
        </div>
